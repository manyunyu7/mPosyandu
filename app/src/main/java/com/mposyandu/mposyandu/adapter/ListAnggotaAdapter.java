...
public class ListAnggotaAdapter extends RecyclerView.Adapter<ListAnggotaAdapter.anggotaViewHolder> implements Filterable {
    private List<AnggotaModel> anggota;
    private List<AnggotaModel> copy;
    ...
    private class RecordFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint.toString().isEmpty()) {
                ...
                List<AnggotaModel> record = new ArrayList<>();

                for (AnggotaModel a : anggota) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            anggota = (List<AnggotaModel>) results.values;
    ...
    public ListAnggotaAdapter(List<AnggotaModel> anggota) {
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        ListAnggotaAdapter.clickListener = clickListener;
    }
    ...
    public AnggotaModel getItem(int position) {
